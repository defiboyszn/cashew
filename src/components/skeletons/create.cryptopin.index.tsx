...
const SkeletonLoader = (function SkeletonLoader() {
    return (
        <div className="flex flex-col w-full h-screen space-y-3 sm:pt-12">
            <div className="pt-5">
            ...
            <div className="flex flex-col items-center  animate-pulse">
                <div className="flex flex-col items-center w-full gap-6">
                    ...
                    <div
                        className="w-full h-14 px-4 py-[18px] bg-primary/60 rounded-lg justify-center items-center gap-2 inline-flex">
                    </div>
                </div>
            </div>
        </div>
